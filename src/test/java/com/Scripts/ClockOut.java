...
public class ClockOut {
	public class ClockIn {
		...
		driver.findElement(By.id("submit-login")).click();
		  ...
		  WebElement firstwindow=driver.findElement(By.id("clock-out"));
		 firstwindow.click();
			 ...
			 * System.out.println(url); Thread.sleep (5000); //driver.findElement(By.xpath(
			 * "//*[@id=\"task_div\"]/div/div[1]/div/div/button]")).click();
			 */
